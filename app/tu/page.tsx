...
import { ArrowLeft, ArrowRight, BookOpen, Cross } from "lucide-react"
import { Button } from "@/components/ui/button"
import { SiteNav } from "@/components/site-nav"
import { SiteFooter } from "@/components/site-footer"

export const metadata = {
  title: "Cranmer House at TU | Episcopal Campus Ministry",
  description:
    "An Episcopal campus ministry at the University of Tulsa. We read the Church Fathers, pray the Office, and follow the way of Christ together.",
}
      ...
      <section className="relative pt-16 min-h-[80vh] flex items-center bg-primary text-primary-foreground overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 py-24 w-full">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <p className="text-stone-light text-sm tracking-[0.2em] uppercase mb-6">
                Cranmer House at TU
              </p>
              <h1 className="font-serif text-5xl lg:text-6xl text-primary-foreground leading-tight mb-10">
                Come Pray With Us. Come Learn With Us. Come Home.
              </h1>
              <Button
                asChild
                size="lg"
            ...
            <div className="hidden lg:block">
              <blockquote className="border-l-2 border-stone pl-8">
                <p className="font-serif text-xl lg:text-2xl text-primary-foreground/90 italic leading-relaxed mb-6">
                  &ldquo;You have made us for yourself, O Lord, and our heart is restless
                  until it finds its rest in you.&rdquo;
                </p>
      ...
      <section className="py-24 lg:py-32 bg-background">
        <div className="max-w-4xl mx-auto px-6 lg:px-12">
          ...
          <h2 className="font-serif text-4xl lg:text-5xl text-foreground leading-tight mb-10">
            A Living Tradition for Your Questions
          </h2>
          <div className="space-y-6 text-foreground/70 text-lg leading-relaxed">
            <p>
              Cranmer House is an Episcopal campus ministry rooted in the Anglican tradition.
              We are at the University of Tulsa for anyone who wants to pray, learn seriously
              about faith, and find a community that takes both seriously.
            </p>
            <p>
              We take the ancient faith of the Church seriously as a living tradition that has
              something for us now. All Christians throughout history have wrestled with the
              same questions you're wrestling with. Augustine doubted. Athanasius stood alone.
              Chrysostom preached to people who weren't sure they believed. They found their
              way through. So can you.
            </p>
            <p>
              We meet together for prayer on the TU campus, praying for one another, the
              university, our community, and our world. Whether you grew up in church or have
              never set foot in one, you are welcome here. We're starting Cranmer House this
              year and would love for you to help us shape what it becomes.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-primary-foreground/70 text-lg leading-relaxed mb-10">
                ...
                every other Thursday at TU and every other Thursday at ORU. We read the Church
                Fathers slowly and seriously. If you're curious about what Sts. Augustine,
                Athanasius, and John Chrysostom actually said, come find out.
              </p>
              <Button
                asChild
                size="lg"
            ...
            <div className="hidden lg:block">
              <div className="border border-primary-foreground/10 p-10 space-y-6">
                ...
                <p className="text-primary-foreground/60 leading-relaxed">
                  On TU campus. Check the calendar for this week's location and reading.
                </p>
                <Link
                  href="/calendar"
      ...
      <section className="py-24 lg:py-32 bg-secondary">
        <div className="max-w-4xl mx-auto px-6 lg:px-12 text-center">
          ...
          <p className="text-foreground/70 text-lg leading-relaxed mb-10 max-w-xl mx-auto">
            No prerequisites, no quiz at the door. Just bring yourself and your questions.
          </p>
